...
static func _ensure_init() -> void:
	...
	_defs[Block.UpperType.EMERALD_TOWER] = Def.new(
		Block.Type.GREEN,
	...
	_defs[Block.UpperType.DARK_PAWN] = Def.new(
		Block.Type.DARK,
		Color(0.52, 0.30, 0.82),
		"Pawn",
	)
	_defs[Block.UpperType.DARK_QUEEN] = Def.new(
		Block.Type.DARK,
		Color(0.66, 0.38, 0.96),
		"Queen",
	)
