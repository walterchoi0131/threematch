...
var _translations: Dictionary = {
	...
	"Fireball DESC": {"zh": "消除 9+ 火寶石：在點擊處生成火球寶石；點擊後造成 3×3 範圍爆炸，並向上下左右各延伸 1 格。", "en": "Blast 9+ fire gems: create a Fireball gem at tapped cell. Click to detonate: 3×3 area plus 1 extra cell in each cardinal direction."},
	...
	"Iai: Water Soul": {"zh": "居合.水魂", "en": "Iai: Water Soul"},
	"Iai: Water Soul DESC": {"zh": "消除棋盤上所有水寶石，數量儲存於下一次水屬性攻擊時併入。CD：5 回合。", "en": "Blast all water gems on the board. The destroyed count is stored and added to the next water attack. CD: 5 turns."},
