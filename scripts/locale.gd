...
var _translations: Dictionary = {
	...
	"Gem Gate": {"zh": "寶石門檻", "en": "Gem Gate"},
	"Gem Gate DESC": {"zh": "本回合爆破少於 %d 顆%s寶石時，受到的傷害變成 1。達標後才會受到正常傷害。", "en": "Requires %d+ %s gems blasted this turn to deal normal damage. Otherwise incoming damage becomes 1."},
